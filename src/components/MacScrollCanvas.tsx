...
const textOverlays: TextOverlay[] = [
    {
        text: "MacBook Pro",
        subtext: "Supercharged by M3 Pro and M3 Max.",
        scrollStart: 0,
        scrollEnd: 0.15,
        position: "center",
    },
    {
        text: "Liquid Retina XDR",
        subtext: "The best display in the world.",
        scrollStart: 0.2,
        scrollEnd: 0.35,
        position: "left",
    },
    ...
    {
        text: "Performance",
        subtext: "Blows away the competition.",
        scrollStart: 0.6,
        scrollEnd: 0.75,
        position: "center",
    },
        ...
        const loadImages = async () => {
            ...
            const promises = Array.from({ length: TOTAL_FRAMES }, (_, i) => {
                return new Promise<HTMLImageElement>((resolve, reject) => {
                    ...
                    img.src = `/MacAnimated/${FRAME_PREFIX}${frameNumber}.jpg`;
                    img.onload = () => {
                        loaded++;
